...
public:
	...
	virtual void BeforeClose(int ret);
	virtual void OnOK();
	virtual void Panelize();
	...
	int		titleheight;
	int		noheader, noclosebox, nominbox, noupbox, nomove;
	int		nof4exit;
...
protected:
	...
	CRect	closerect, titlerect, minrect, uprect;
	CRect	closerect2, titlerect2, minrect2, uprect2;
	...
	afx_msg LRESULT CGrayDlg::OnMouseLeave(WPARAM, LPARAM);
	//}}AFX_MSG
