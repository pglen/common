...
public:
	...
	/// index
	inline int CxPtrArr::GetSize() const
		{ return m_nSize; }
	...
	inline int CxPtrArr::GetUpperBound() const
		{ return m_nSize-1; }
	...
	inline void CxPtrArr::RemoveAll()
		{ SetSize(0); }

	// Accessing elements

	/// Get member helper
	inline void* CxPtrArr::GetAt(int nIndex) const
		{ //ASSERT(nIndex >= 0 && nIndex < m_nSize);
			return m_pData[nIndex]; }

	/// Set member helper
	inline void CxPtrArr::SetAt(int nIndex, void* newElement)
		{ //ASSERT(nIndex >= 0 && nIndex < m_nSize);
			m_pData[nIndex] = newElement; }

	/// Get member helper
	inline void*& CxPtrArr::ElementAt(int nIndex)
		{ //ASSERT(nIndex >= 0 && nIndex < m_nSize);
			return m_pData[nIndex]; }
	...
	inline int CxPtrArr::Add(void* newElement)
		{ int nIndex = m_nSize;
